...
extern "C" void unity_inita(int argc, char* argv[])
{
    @autoreleasepool
    {
        UnityInitTrampoline();
...
extern "C" void UnityPostMessagea(NSString* gameObject, NSString* methodName, NSString* message)
{
...
extern "C" void UnityToggleRotationa(bool isOn)
{
